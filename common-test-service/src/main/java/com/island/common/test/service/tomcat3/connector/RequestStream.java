package com.island.common.test.service.tomcat3.connector;
...
import com.island.common.test.service.tomcat3.connector.http.Constants;
import com.island.common.test.service.tomcat3.connector.http.HttpRequest;

/**
 * Convenience implementation of <b>ServletInputStream</b> that works with the standard implementations of
 * <b>Request</b>. If the content length has been set on our associated Request, this implementation will enforce not
 * reading more than that many bytes on the underlying stream.
 *
...
public class RequestStream extends ServletInputStream {
    ...
    /**
     * Close this input stream. No physical level I-O is performed, but any further attempt to read from this stream
     * will throw an IOException. If a content length has been set but not all of the bytes have yet been consumed, the
    ...
    /**
     * Read some number of bytes from the input stream, and store them into the buffer array b. The number of bytes
    ...
    /**
     * Read up to <code>len</code> bytes of data from the input stream into an array of bytes. An attempt is made to
